...
export default class JwtService {
  ...
  getRefreshToken() {
    return localStorage.getItem(this.jwtConfig.refreshToken)
  }

  setToken(value) {
    localStorage.setItem(this.jwtConfig.accessToken, value)
  }

  setRefreshToken(value) {
    localStorage.setItem(this.jwtConfig.refreshToken, value)
  }
